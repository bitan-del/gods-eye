...
async function createConversationRuntimeMock(
  importOriginal: () => Promise<typeof import("godseye/plugin-sdk/conversation-runtime")>,
) {
...
vi.mock("godseye/plugin-sdk/conversation-runtime", createConversationRuntimeMock);
vi.mock("godseye/plugin-sdk/conversation-runtime.js", createConversationRuntimeMock);
