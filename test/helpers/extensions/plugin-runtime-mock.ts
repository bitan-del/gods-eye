import { DEFAULT_MODEL, DEFAULT_PROVIDER } from "godseye/plugin-sdk/agent-runtime";
import type { PluginRuntime } from "godseye/plugin-sdk/testing";
import { removeAckReactionAfterReply, shouldAckReaction } from "godseye/plugin-sdk/testing";
...
export function createPluginRuntimeMock(overrides: DeepPartial<PluginRuntime> = {}): PluginRuntime {
  const base: PluginRuntime = {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/godseye"),
    },
    modelAuth: {
