...
import { openClawRootFs, openClawRootFsSync } from "./godseye-root.fs.runtime.js";

const CORE_PACKAGE_NAMES = new Set(["godseye", "openclaw"]);
...
export async function resolveGodsEyePackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolveGodsEyePackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {
