...
export function listAuthProfileStorePaths(config: GodsEyeConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: GodsEyeConfig, stateDir: string): string[] {
