...
function resolveAvatarSource(cfg: GodsEyeConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: GodsEyeConfig, agentId: string): AgentAvatarResolution {
