...
const CLEANUP_STATE_KEY = Symbol.for("godseye.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("godseye.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("godseye.sessionWriteLockWatchdogState");
