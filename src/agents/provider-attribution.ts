...
const GODSEYE_ATTRIBUTION_PRODUCT = "Gods Eye";
const GODSEYE_ATTRIBUTION_ORIGINATOR = "godseye";

export function resolveProviderAttributionIdentity(
  env: RuntimeVersionEnv = process.env as RuntimeVersionEnv,
): ProviderAttributionIdentity {
  return {
    product: GODSEYE_ATTRIBUTION_PRODUCT,
...
function buildOpenAIAttributionPolicy(
  ...
  return {
    ...
    ...identity,
    headers: {
      originator: GODSEYE_ATTRIBUTION_ORIGINATOR,
      "User-Agent": `${GODSEYE_ATTRIBUTION_ORIGINATOR}/${identity.version}`,
    },
  };
}
