...
function resolveAdaptiveReadMaxBytes(options?: GodsEyeReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createGodsEyeReadTool(base, {
...
export function createGodsEyeReadTool(
  base: AnyAgentTool,
  options?: GodsEyeReadToolOptions,
): AnyAgentTool {
