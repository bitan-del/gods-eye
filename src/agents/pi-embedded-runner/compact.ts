...
function resolvePostCompactionIndexSyncMode(config?: GodsEyeConfig): "off" | "async" | "await" {
...
export async function compactEmbeddedPiSessionDirect(
  ...
  await ensureGodsEyeModelsJson(params.config, agentDir);
  ...
  try {
    ...
    const toolsRaw = createGodsEyeCodingTools({
      exec: {
