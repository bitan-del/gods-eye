...
export const DEFAULT_SANDBOX_IMAGE = "godseye-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "godseye-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "godseye-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "godseye-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "godseye-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "godseye-sandbox-browser";
