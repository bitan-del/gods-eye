...
function resolveWatchPaths(workspaceDir: string, config?: GodsEyeConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: GodsEyeConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: GodsEyeConfig }) {
