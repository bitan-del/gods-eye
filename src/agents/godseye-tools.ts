...
let godsEyeToolsDeps: GodsEyeToolsDeps = defaultGodsEyeToolsDeps;

export function createGodsEyeTools(
  options?: {
  ...
  const resolvedConfig = options?.config ?? godsEyeToolsDeps.config;
  ...
  const tools: AnyAgentTool[] = [
    ...
    createSessionsListTool({
      ...
      callGateway: godsEyeToolsDeps.callGateway,
    }),
...
export const __testing = {
  setDepsForTest(overrides?: Partial<GodsEyeToolsDeps>) {
    godsEyeToolsDeps = overrides
      ? {
          ...defaultGodsEyeToolsDeps,
          ...overrides,
        }
      : defaultGodsEyeToolsDeps;
  },
