...
export function isCliProvider(provider: string, cfg?: GodsEyeConfig): boolean {
...
function resolveAllowedFallbacks(params: { cfg: GodsEyeConfig; agentId?: string }): string[] {
  if (params.agentId) {
...
export function buildConfiguredModelCatalog(params: { cfg: GodsEyeConfig }): ModelCatalogEntry[] {
