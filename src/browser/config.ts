...
import {
  ...
  DEFAULT_GODSEYE_BROWSER_ENABLED,
...
function normalizeHexColor(raw: string | undefined) {
  ...
  if (!value) {
    return DEFAULT_GODSEYE_BROWSER_COLOR;
  }
...
/**
 * Ensure the default "godseye" profile exists in the profiles map.
...
function ensureDefaultProfile(
  ...
  if (!result[DEFAULT_GODSEYE_BROWSER_PROFILE_NAME]) {
    result[DEFAULT_GODSEYE_BROWSER_PROFILE_NAME] = {
...
export function resolveBrowserConfig(
  ...
  const defaultProfile =
    ...
    (profiles[DEFAULT_BROWSER_DEFAULT_PROFILE_NAME]
      ? DEFAULT_BROWSER_DEFAULT_PROFILE_NAME
      : profiles[DEFAULT_GODSEYE_BROWSER_PROFILE_NAME]
        ? DEFAULT_GODSEYE_BROWSER_PROFILE_NAME
        : "user");
...
export function resolveProfile(
  ...
  let cdpUrl = "";
  const driver = profile.driver === "existing-session" ? "existing-session" : "godseye";
