...
import type { GodsEyePluginApi, GodsEyePluginConfigSchema } from "../plugins/types.js";
...
type DefineChannelPluginEntryOptions<TPlugin = ChannelPlugin> = {
  ...
  registerFull?: (api: GodsEyePluginApi) => void;
};
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: GodsEyeConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
