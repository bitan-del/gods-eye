...
import type {
  ...
  GodsEyePluginApi as CoreGodsEyePluginApi,
  PluginRuntime as CorePluginRuntime,
} from "godseye/plugin-sdk/core";
import * as providerEntrySdk from "godseye/plugin-sdk/provider-entry";
...
import type {
  ...
  GodsEyePluginApi as SharedGodsEyePluginApi,
...
describe("plugin-sdk subpath exports", () => {
  ...
  it("keeps shared plugin-sdk types aligned", () => {
    ...
    expectTypeOf<CoreGodsEyePluginApi>().toMatchTypeOf<GodsEyePluginApi>();
    expectTypeOf<CorePluginRuntime>().toMatchTypeOf<PluginRuntime>();
    expectTypeOf<CoreChannelMessageActionContext>().toMatchTypeOf<ChannelMessageActionContext>();
    expectTypeOf<CoreGodsEyePluginApi>().toMatchTypeOf<SharedGodsEyePluginApi>();
  ...
  it("keeps runtime entry subpaths importable", async () => {
    const [
      ...
      importResolvedPluginSdkSubpath("godseye/plugin-sdk/core"),
      importResolvedPluginSdkSubpath("godseye/plugin-sdk/text-runtime"),
      importResolvedPluginSdkSubpath("godseye/plugin-sdk/plugin-entry"),
      importResolvedPluginSdkSubpath("godseye/plugin-sdk/channel-lifecycle"),
      importResolvedPluginSdkSubpath("godseye/plugin-sdk/channel-pairing"),
      importResolvedPluginSdkSubpath("godseye/plugin-sdk/channel-reply-pipeline"),
      ...representativeRuntimeSmokeSubpaths.map((id) =>
        importResolvedPluginSdkSubpath(`godseye/plugin-sdk/${id}`),
      ),
    ]);
