...
type FacadeModule = typeof import("@godseye/qa-channel/api.js");
import {
...
export type QaBusAttachment = import("@godseye/qa-channel/api.js").QaBusAttachment;
export type QaBusConversation = import("@godseye/qa-channel/api.js").QaBusConversation;
export type QaBusConversationKind = import("@godseye/qa-channel/api.js").QaBusConversationKind;
export type QaBusCreateThreadInput = import("@godseye/qa-channel/api.js").QaBusCreateThreadInput;
export type QaBusDeleteMessageInput = import("@godseye/qa-channel/api.js").QaBusDeleteMessageInput;
export type QaBusEditMessageInput = import("@godseye/qa-channel/api.js").QaBusEditMessageInput;
export type QaBusEvent = import("@godseye/qa-channel/api.js").QaBusEvent;
export type QaBusInboundMessageInput =
  import("@godseye/qa-channel/api.js").QaBusInboundMessageInput;
export type QaBusMessage = import("@godseye/qa-channel/api.js").QaBusMessage;
export type QaBusOutboundMessageInput =
  import("@godseye/qa-channel/api.js").QaBusOutboundMessageInput;
export type QaBusPollInput = import("@godseye/qa-channel/api.js").QaBusPollInput;
export type QaBusPollResult = import("@godseye/qa-channel/api.js").QaBusPollResult;
export type QaBusReactToMessageInput =
  import("@godseye/qa-channel/api.js").QaBusReactToMessageInput;
export type QaBusReadMessageInput = import("@godseye/qa-channel/api.js").QaBusReadMessageInput;
export type QaBusSearchMessagesInput =
  import("@godseye/qa-channel/api.js").QaBusSearchMessagesInput;
export type QaBusStateSnapshot = import("@godseye/qa-channel/api.js").QaBusStateSnapshot;
export type QaBusThread = import("@godseye/qa-channel/api.js").QaBusThread;
export type QaBusWaitForInput = import("@godseye/qa-channel/api.js").QaBusWaitForInput;
