...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof GodsEyeConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: GodsEyeConfig; env: NodeJS.ProcessEnv }): {
  cfg: GodsEyeConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
