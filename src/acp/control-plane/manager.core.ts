...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: GodsEyeConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: GodsEyeConfig): AcpManagerObservabilitySnapshot {
  ...
  private resolveTurnTimeoutMs(params: { cfg: GodsEyeConfig; meta: SessionAcpMeta }): number {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: GodsEyeConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: GodsEyeConfig }): Promise<void> {
