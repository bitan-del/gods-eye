...
import type {
  ...
  GodsEyePluginApi,
  GodsEyePluginChannelRegistration,
  GodsEyePluginCliRegistrar,
  GodsEyePluginCommandDefinition,
  PluginConversationBindingResolvedEvent,
  GodsEyePluginHttpRouteAuth,
  GodsEyePluginHttpRouteMatch,
  GodsEyePluginHttpRouteHandler,
  GodsEyePluginHttpRouteParams,
  GodsEyePluginHookOptions,
...
export type PluginToolRegistration = {
  pluginId: string;
  pluginName?: string;
  factory: GodsEyePluginToolFactory;
  names: string[];
  optional: boolean;
  source: string;
  rootDir?: string;
...
export type PluginCliRegistration = {
  pluginId: string;
  pluginName?: string;
  register: GodsEyePluginCliRegistrar;
  commands: string[];
  source: string;
  rootDir?: string;
};
...
export type PluginCommandRegistration = {
  pluginId: string;
  pluginName?: string;
  command: GodsEyePluginCommandDefinition;
  source: string;
  rootDir?: string;
};
...
export function createPluginRegistry(registryParams: PluginRegistryParams) {
  ...
  const registerTool = (
    ...
    const factory: GodsEyePluginToolFactory =
      typeof tool === "function" ? tool : (_ctx: GodsEyePluginToolContext) => tool;
  ...
  const registerHook = (
    ...
    opts: GodsEyePluginHookOptions | undefined,
    config: GodsEyePluginApi["config"],
  ) => {
  ...
  const registerHttpRoute = (record: PluginRecord, params: GodsEyePluginHttpRouteParams) => {
  ...
  const registerChannel = (
    record: PluginRecord,
    registration: GodsEyePluginChannelRegistration | ChannelPlugin,
    mode: PluginRegistrationMode = "full",
  ) => {
    const normalized =
      typeof (registration as GodsEyePluginChannelRegistration).plugin === "object"
        ? (registration as GodsEyePluginChannelRegistration)
  ...
  const registerCli = (
    record: PluginRecord,
    registrar: GodsEyePluginCliRegistrar,
  ...
  const registerService = (record: PluginRecord, service: GodsEyePluginService) => {
  ...
  const registerCommand = (record: PluginRecord, command: GodsEyePluginCommandDefinition) => {
