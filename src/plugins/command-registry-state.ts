...
import type { GodsEyePluginCommandDefinition } from "./types.js";

export type RegisteredPluginCommand = GodsEyePluginCommandDefinition & {
  pluginId: string;
  pluginName?: string;
  pluginRoot?: string;
};
...
const PLUGIN_COMMAND_STATE_KEY = Symbol.for("godseye.pluginCommandsState");
