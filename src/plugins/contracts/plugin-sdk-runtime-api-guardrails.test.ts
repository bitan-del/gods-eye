...
const RUNTIME_API_EXPORT_GUARDS: Record<string, readonly string[]> = {
  ...
  [bundledPluginFile("imessage", "runtime-api.ts")]: [
    'export { DEFAULT_ACCOUNT_ID, getChatChannelMeta, type ChannelPlugin, type OpenClawConfig } from "godseye/plugin-sdk/core";',
    ...
    'export { buildComputedAccountStatusSnapshot, collectStatusIssuesFromLastError } from "godseye/plugin-sdk/status-helpers";',
  ...
  [bundledPluginFile("googlechat", "runtime-api.ts")]: [
    ...
    'export { createActionGate, jsonResult, readNumberParam, readReactionParams, readStringParam } from "godseye/plugin-sdk/channel-actions";',
    'export { buildChannelConfigSchema } from "godseye/plugin-sdk/channel-config-primitives";',
    'export type { ChannelMessageActionAdapter, ChannelMessageActionName, ChannelStatusIssue } from "godseye/plugin-sdk/channel-contract";',
    'export { missingTargetError } from "godseye/plugin-sdk/channel-feedback";',
    'export { createAccountStatusSink, runPassiveAccountLifecycle } from "godseye/plugin-sdk/channel-lifecycle";',
    ...
    'export { evaluateGroupRouteAccessForPolicy, resolveDmGroupAccessWithLists, resolveSenderScopedGroupPolicy } from "godseye/plugin-sdk/channel-policy";',
    'export { PAIRING_APPROVED_MESSAGE } from "godseye/plugin-sdk/channel-status";',
    ...
    'export { GROUP_POLICY_BLOCKED_LABEL, isDangerousNameMatchingEnabled, resolveAllowlistProviderRuntimeGroupPolicy, resolveDefaultGroupPolicy, warnMissingProviderGroupPolicyFallbackOnce } from "godseye/plugin-sdk/config-runtime";',
    ...
    'export { GoogleChatConfigSchema, type GoogleChatAccountConfig, type GoogleChatConfig } from "godseye/plugin-sdk/googlechat-runtime-shared";',
    ...
    'export { registerWebhookTargetWithPluginRoute, resolveWebhookTargetWithAuthOrReject, withResolvedWebhookRequestPipeline } from "godseye/plugin-sdk/webhook-targets";',
    'export { createWebhookInFlightLimiter, readJsonWebhookBodyOrReject, type WebhookInFlightLimiter } from "godseye/plugin-sdk/webhook-request-guards";',
  ...
  [bundledPluginFile("matrix", "runtime-api.ts")]: [
    ...
    'export { assertHttpUrlTargetsPrivateNetwork, closeDispatcher, createPinnedDispatcher, resolvePinnedHostnameWithPolicy, ssrfPolicyFromDangerouslyAllowPrivateNetwork, ssrfPolicyFromAllowPrivateNetwork, type LookupFn, type SsrFPolicy } from "godseye/plugin-sdk/ssrf-runtime";',
    ...
    'export type { ChannelDirectoryEntry, ChannelMessageActionContext, OpenClawConfig, PluginRuntime, RuntimeLogger, RuntimeEnv, WizardPrompter } from "godseye/plugin-sdk/matrix-runtime-shared";',
    'export { formatZonedTimestamp } from "godseye/plugin-sdk/matrix-runtime-shared";',
  ...
  [bundledPluginFile("nextcloud-talk", "runtime-api.ts")]: [
    'export * from "godseye/plugin-sdk/nextcloud-talk";',
  ...
  [bundledPluginFile("telegram", "runtime-api.ts")]: [
    ...
    'export type { OpenClawPluginService, OpenClawPluginServiceContext, PluginLogger } from "godseye/plugin-sdk/plugin-entry";',
    'export type { PluginRuntime } from "godseye/plugin-sdk/runtime-store";',
    'export type { AcpRuntime, AcpRuntimeCapabilities, AcpRuntimeDoctorReport, AcpRuntimeEnsureInput, AcpRuntimeEvent, AcpRuntimeHandle, AcpRuntimeStatus, AcpRuntimeTurnInput, AcpRuntimeErrorCode, AcpSessionUpdateTag } from "godseye/plugin-sdk/acp-runtime";',
    'export { AcpRuntimeError } from "godseye/plugin-sdk/acp-runtime";',
    'export { emptyPluginConfigSchema, formatPairingApproveHint, getChatChannelMeta } from "godseye/plugin-sdk/channel-plugin-common";',
    ...
    'export { PAIRING_APPROVED_MESSAGE, buildTokenChannelStatusSummary, projectCredentialSnapshotFields, resolveConfiguredFromCredentialStatuses } from "godseye/plugin-sdk/channel-status";',
    'export { jsonResult, readNumberParam, readReactionParams, readStringArrayParam, readStringOrNumberParam, readStringParam, resolvePollMaxSelections } from "godseye/plugin-sdk/channel-actions";',
