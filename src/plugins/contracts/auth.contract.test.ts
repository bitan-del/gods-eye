...
type LoginOpenAICodexOAuth =
  (typeof import("godseye/plugin-sdk/provider-auth-login"))["loginOpenAICodexOAuth"];
type GithubCopilotLoginCommand =
  (typeof import("godseye/plugin-sdk/provider-auth-login"))["githubCopilotLoginCommand"];
type CreateVpsAwareHandlers =
  (typeof import("../provider-oauth-flow.js"))["createVpsAwareOAuthHandlers"];
type EnsureAuthProfileStore =
  typeof import("godseye/plugin-sdk/agent-runtime").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("godseye/plugin-sdk/agent-runtime").listProfilesForProvider;
...
vi.mock("godseye/plugin-sdk/provider-auth-login", async (importOriginal) => {
  const actual = await importOriginal<typeof import("godseye/plugin-sdk/provider-auth-login")>();
  return {
    ...actual,
...
vi.mock("godseye/plugin-sdk/agent-runtime", async (importOriginal) => {
