...
export function applyGoogleGeminiModelDefault(cfg: GodsEyeConfig): {
  next: GodsEyeConfig;
  changed: boolean;
} {
...
export function applyOpenAIProviderConfig(cfg: GodsEyeConfig): GodsEyeConfig {
...
export function applyOpenAIConfig(cfg: GodsEyeConfig): GodsEyeConfig {
...
export function applyOpencodeGoModelDefault(cfg: GodsEyeConfig): {
  next: GodsEyeConfig;
  changed: boolean;
} {
...
export function applyOpencodeZenModelDefault(cfg: GodsEyeConfig): {
  next: GodsEyeConfig;
  changed: boolean;
} {
