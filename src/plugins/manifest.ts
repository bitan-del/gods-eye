...
export const PLUGIN_MANIFEST_FILENAME = "godseye.plugin.json";
...
// package.json "godseye" metadata (used for setup/catalog)
...
export type GodsEyePackageStartup = {
  /**
...
export type GodsEyePackageManifest = {
  extensions?: string[];
  setupEntry?: string;
  channel?: PluginPackageChannel;
  install?: PluginPackageInstall;
  startup?: GodsEyePackageStartup;
};
...
): GodsEyePackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
