...
import { normalizeGodsEyeVersionBase } from "../config/version.js";
import { createSubsystemLogger } from "../logging/subsystem.js";
import { resolveRuntimeServiceVersion } from "../version.js";
import { inspectBundleLspRuntimeSupport } from "./bundle-lsp.js";
import { inspectBundleMcpRuntimeSupport } from "./bundle-mcp.js";
import { normalizePluginsConfig } from "./config-state.js";
import { loadGodsEyePlugins } from "./loader.js";
...
function resolveReportedPluginVersion(
  ...
  return (
    normalizeGodsEyeVersionBase(resolveRuntimeServiceVersion(env)) ??
    normalizeGodsEyeVersionBase(plugin.version) ??
    plugin.version
  );
}
