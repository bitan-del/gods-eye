...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("godseye.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("godseye.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: GodsEyeConfig): Promise<ContextEngine> {
