...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.GODSEYE_SERVICE_MARKER;
  ...
  beforeEach(async () => {
    ...
    delete process.env.GODSEYE_SERVICE_MARKER;
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.GODSEYE_SERVICE_MARKER = originalServiceMarker;
    }
  });
