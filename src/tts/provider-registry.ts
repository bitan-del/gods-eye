...
function resolveSpeechProviderPluginEntries(cfg?: GodsEyeConfig): SpeechProviderPlugin[] {
...
export function listSpeechProviders(cfg?: GodsEyeConfig): SpeechProviderPlugin[] {
