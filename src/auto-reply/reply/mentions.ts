...
function resolveMentionPatterns(cfg: GodsEyeConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: GodsEyeConfig | undefined, agentId?: string): RegExp[] {
