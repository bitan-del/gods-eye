...
function createMatrixThreadCommandParams(commandBody: string, cfg: GodsEyeConfig = baseCfg) {
...
function createMatrixRoomCommandParams(commandBody: string, cfg: GodsEyeConfig = baseCfg) {
  const params = buildCommandTestParams(commandBody, cfg, {
    Provider: "matrix",
    Surface: "matrix",
    OriginatingChannel: "matrix",
