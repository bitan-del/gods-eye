...
function resolveAcpStreamCoalesceIdleMs(cfg: GodsEyeConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: GodsEyeConfig): number {
...
export function resolveAcpProjectionSettings(cfg: GodsEyeConfig): AcpProjectionSettings {
