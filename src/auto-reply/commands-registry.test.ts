...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@godseye", { botUsername: "godseye" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@godseye args", {
        botUsername: "godseye",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "godseye" })).toBe(
      "/help@otherbot",
    );
  });
