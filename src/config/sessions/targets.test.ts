...
function createCustomRootCfg(customRoot: string, defaultAgentId = "ops"): GodsEyeConfig {
  return {
    session: {
...
const discoveryResolvers = [
  {
    label: "async",
    resolve: async (cfg: GodsEyeConfig, env: NodeJS.ProcessEnv) =>
