    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["godseye directory self --channel slack", "Show the connected account identity."],
          [
            'godseye directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["godseye directory groups list --channel discord", "List available groups/channels."],
          [
            "godseye directory groups members --channel discord --group-id <id>",
