const DEFAULT_TAGLINE = "All your chats, one GodsEye.";
...
const TAGLINES: string[] = [
  "Your terminal just got sharper—type something and let the bot handle the busywork.",
  ...
  "Automation with vision: minimal fuss, maximal impact.",
  ...
  "Eyes open, commit in—let's ship something mildly responsible.",
  "I'll streamline your workflow: clean, efficient, effective.",
  "Shell yeah—I'm here to spot the toil and leave you the glory.",
  "If it's repetitive, I'll automate it; if it's hard, I'll bring jokes and a rollback plan.",
  "The only AI in your contacts you actually want to hear from. 👁️",
  ...
  "Built for creators, by builders. Don't question the hierarchy.",
  ...
  "The only open-source project where the AI sees everything you need done.",
  ...
  "Half butler, half debugger, full omniscience.",
  ...
  "The all-seeing eye in your shell. 👁️",
  ...
  "You had me at 'godseye gateway start.'",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.GODSEYE_TAGLINE_INDEX;
