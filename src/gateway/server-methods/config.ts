...
import type { ConfigValidationIssue, GodsEyeConfig } from "../../config/types.godseye.js";
import {
...
function parseValidateConfigFromRawOrRespond(
  ...
  snapshot: Awaited<ReturnType<typeof readConfigFileSnapshot>>,
  respond: RespondFn,
): { config: GodsEyeConfig; schema: ConfigSchemaResponse } | null {
...
function loadSchemaWithPlugins(): ConfigSchemaResponse {
  ...
  // our cache. However, loadConfig() and loadGodsEyePlugins() (called inside
