...
describe("gateway auth", () => {
  ...
  it("resolves token/password from GODSEYE gateway env vars", () => {
    expect(
      resolveGatewayAuth({
        authConfig: {},
        env: {
          GODSEYE_GATEWAY_TOKEN: "env-token",
          GODSEYE_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides GODSEYE_GATEWAY_PASSWORD", () => {
