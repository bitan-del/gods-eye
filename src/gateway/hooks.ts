...
export function resolveHooksConfig(cfg: GodsEyeConfig): HooksConfigResolved | null {
...
function resolveKnownAgentIds(cfg: GodsEyeConfig, defaultAgentId: string): Set<string> {
...
export function resolveHookIdempotencyKey(params: {
  ...
  return (
    ...
    resolveOptionalHookIdempotencyKey(params.headers?.["x-godseye-idempotency-key"]) ||
