...
export function collectConfiguredModelPricingRefs(config: GodsEyeConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: GodsEyeConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();
