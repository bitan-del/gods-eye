...
export function hasAmbiguousGatewayAuthModeConfig(cfg: GodsEyeConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: GodsEyeConfig): void {
