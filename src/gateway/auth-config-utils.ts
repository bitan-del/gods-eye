import type { GatewayAuthConfig, GodsEyeConfig } from "../config/config.js";
import { resolveSecretInputRef } from "../config/types.secrets.js";
import { resolveRequiredConfiguredSecretRefInputString } from "./resolve-configured-secret-input-string.js";

export function withGatewayAuthPassword(cfg: GodsEyeConfig, password: string): GodsEyeConfig {
  return {
    ...cfg,
    gateway: {
      ...cfg.gateway,
