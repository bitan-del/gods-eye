...
function buildNoImageGenerationModelConfiguredMessage(cfg: GodsEyeConfig): string {
...
export function listRuntimeImageGenerationProviders(params?: { config?: GodsEyeConfig }) {
