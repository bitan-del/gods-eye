...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.gods-eye.org/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("godseye hooks list")}`,
      `  ${formatCliCommand("godseye hooks enable <name>")}`,
      `  ${formatCliCommand("godseye hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
