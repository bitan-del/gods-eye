...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set GODSEYE_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `godseye dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control GodsEye.");
  } else if (hint) {
    runtime.log(hint);
  }
}
