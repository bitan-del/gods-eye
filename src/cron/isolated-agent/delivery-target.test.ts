...
function makeCfg(overrides?: Partial<GodsEyeConfig>): GodsEyeConfig {
  return {
    bindings: [],
    channels: {},
    ...overrides,
...
function makeTelegramBoundCfg(accountId = "account-b"): GodsEyeConfig {
  return makeCfg({
    bindings: [
      {
        agentId: AGENT_ID,
...
async function resolveLastTarget(cfg: GodsEyeConfig) {
