...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = GodsEyeLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = GodsEyeLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.godseye.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section {
                    DisclosureGroup(isExpanded: self.$gatewayExpanded) {
                        if !self.isGatewayConnected {
                            Text(
                                "1. Open a chat with your GodsEye agent and send /pair\n"
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected GodsEye agent.") { newValue in
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for GodsEye. "
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(GodsEyeLocationMode.off.rawValue)
                            Text("While Using").tag(GodsEyeLocationMode.whileUsing.rawValue)
                            Text("Always").tag(GodsEyeLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while GodsEye is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("Gods Eye", value: DeviceInfoHelper.godsEyeVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = GodsEyeLocationMode(rawValue: newValue) else { return }
                Task {
    ...
    private func friendlyGatewayMessage(from raw: String) -> String? {
        ...
        if lower.contains("pairing required") {
            return "Pairing required. Go back to your GodsEye chat and run /pair approve, then tap Connect again."
        }
