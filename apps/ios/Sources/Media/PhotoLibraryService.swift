...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: GodsEyePhotosLatestParams) async throws -> GodsEyePhotosLatestPayload {
        ...
        var results: [GodsEyePhotoPayload] = []
        ...
        return GodsEyePhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> GodsEyePhotoPayload
    {
