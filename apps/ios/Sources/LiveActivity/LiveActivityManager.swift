...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.godseye.ios", category: "LiveActivity")
    private var currentActivity: Activity<GodsEyeActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = GodsEyeActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<GodsEyeActivityAttributes>.activities
    ...
    private func updateCurrent(state: GodsEyeActivityAttributes.ContentState) {
    ...
    private func connectingState() -> GodsEyeActivityAttributes.ContentState {
        GodsEyeActivityAttributes.ContentState(
    ...
    private func idleState() -> GodsEyeActivityAttributes.ContentState {
        GodsEyeActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> GodsEyeActivityAttributes.ContentState {
        GodsEyeActivityAttributes.ContentState(
