...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.godseye.gateway"
    private static let nodeService = "ai.godseye.node"
    private static let talkService = "ai.godseye.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.godseye.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.godseye.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("godseye-gateway.log")
    }
