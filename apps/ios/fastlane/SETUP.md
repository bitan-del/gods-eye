...
ASC_KEYCHAIN_SERVICE=godseye-asc-key
...
```bash
ASC_APP_IDENTIFIER=ai.godseye.client
# or
...
- The beta flow regenerates `apps/ios/Gods Eye.xcodeproj` from `apps/ios/project.yml` before archiving
