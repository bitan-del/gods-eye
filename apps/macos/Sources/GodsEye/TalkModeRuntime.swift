...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.godseye", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.godseye", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [GodsEyeChatMessage] = messages.compactMap { item in
