...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .godseyeSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? GodsEyePaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? GodsEyePaths.stateDirURL.path
...
extension Notification.Name {
    static let godseyeSelectSettingsTab = Notification.Name("godseyeSelectSettingsTab")
}
