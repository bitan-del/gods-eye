...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.godseye", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other GodsEye windows, but below the system’s pop-up menus.
