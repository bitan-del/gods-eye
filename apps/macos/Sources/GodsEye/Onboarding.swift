...
enum UIStrings {
    static let welcomeTitle = "Welcome to GodsEye"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "godseye.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: GodsEyeChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g godseye@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: GodsEyeChatViewModel(
