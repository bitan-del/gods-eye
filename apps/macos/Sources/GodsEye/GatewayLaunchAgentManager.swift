...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.godseye", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".godseye/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.godseyeCommand(
            subcommand: "gateway",
