...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/bitan-del/gods-eye") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/bitan-del/gods-eye")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://gods-eye.org")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "GodsEyeBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "GodsEyeBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "GodsEyeGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "GodsEyeGitCommit") as? String) ??
            "unknown"
    }
