...
enum GodsEyeConfigFile {
    private static let logger = Logger(subsystem: "ai.godseye", category: "config")
    ...
    static func stateDirURL() -> URL {
        GodsEyePaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        GodsEyePaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-godseye-config-file",
            "event": "config.write",
