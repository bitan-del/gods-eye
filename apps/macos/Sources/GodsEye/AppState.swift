...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = GodsEyeConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = GodsEyeConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: GodsEyeConfigFile.loadDict(),
        ...
        GodsEyeConfigFile.saveDict(synced.root)
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/godseye"
        state.remoteCliPath = ""
        return state
    }
}
