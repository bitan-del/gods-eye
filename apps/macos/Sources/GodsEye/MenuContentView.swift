...
/// Menu contents for the GodsEye menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About GodsEye") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "GodsEye Not Configured"
        case .remote:
            "Remote GodsEye Active"
        case .local:
            "GodsEye Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .godseyeSelectSettingsTab, object: tab)
        }
    }
