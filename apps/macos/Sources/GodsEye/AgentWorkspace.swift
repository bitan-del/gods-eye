...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.godseye", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return GodsEyeConfigFile.defaultWorkspaceURL() }
