...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.godseye", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("GodsEye/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__godseye__/a2ui/").absoluteString + "?platform=macos"
    }
