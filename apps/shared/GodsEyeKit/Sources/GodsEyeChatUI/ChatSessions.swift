...
public struct GodsEyeChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct GodsEyeChatSessionsDefaults: Codable, Sendable {
...
public struct GodsEyeChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct GodsEyeChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: GodsEyeChatSessionsDefaults?
    public let sessions: [GodsEyeChatSessionEntry]
    ...
    public init(
        ...
        sessions: [GodsEyeChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
