...
public typealias GodsEyePlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias GodsEyePlatformImage = UIImage
#endif

public struct GodsEyeChatUsageCost: Codable, Hashable, Sendable {
...
public struct GodsEyeChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: GodsEyeChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(GodsEyeChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct GodsEyeChatMessageContent: Codable, Hashable, Sendable {
...
public struct GodsEyeChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [GodsEyeChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: GodsEyeChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [GodsEyeChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: GodsEyeChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(GodsEyeChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([GodsEyeChatMessageContent].self, forKey: .content) {
...
public struct GodsEyeChatHistoryPayload: Codable, Sendable {
...
public struct GodsEyeSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct GodsEyeSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [GodsEyeSessionPreviewItem]
}

public struct GodsEyeSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [GodsEyeSessionPreviewEntry]

    public init(ts: Int, previews: [GodsEyeSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct GodsEyeChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct GodsEyeChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct GodsEyeAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct GodsEyeChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct GodsEyeGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct GodsEyePendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: GodsEyePlatformImage?
...
public struct GodsEyeChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
