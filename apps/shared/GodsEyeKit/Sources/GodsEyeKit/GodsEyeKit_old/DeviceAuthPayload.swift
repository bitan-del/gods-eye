...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: GodsEyeProtocol.AnyCodable]?
    {
        ...
        return [
            "id": GodsEyeProtocol.AnyCodable(identity.deviceId),
            "publicKey": GodsEyeProtocol.AnyCodable(publicKey),
            "signature": GodsEyeProtocol.AnyCodable(signature),
            "signedAt": GodsEyeProtocol.AnyCodable(signedAtMs),
            "nonce": GodsEyeProtocol.AnyCodable(nonce),
        ]
    }
}
