...
public enum GodsEyeCanvasA2UICommand: String, Codable, Sendable {
...
public struct GodsEyeCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct GodsEyeCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
