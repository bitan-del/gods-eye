...
public enum GodsEyeTalkCommand: String, Codable, Sendable {
...
public struct GodsEyeTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct GodsEyeTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
