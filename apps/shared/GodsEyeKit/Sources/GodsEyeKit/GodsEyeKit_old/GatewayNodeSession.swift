...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.godseye", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.godseye", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: GodsEyeProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
