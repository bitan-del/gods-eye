  ...
  AndroidView(
    ...
    factory = {
      WebView(context).apply {
        ...
        if (isDebuggable) {
          Log.d("GodsEyeWebView", "userAgent: ${settings.userAgentString}")
        }
        ...
        webViewClient =
          object : WebViewClient() {
            ...
            override fun onReceivedError(
              ...
              Log.e("GodsEyeWebView", "onReceivedError: ${error.errorCode} ${error.description} ${request.url}")
            }
            ...
            override fun onPageFinished(view: WebView, url: String?) {
              currentPageUrlRef.set(url)
              if (isDebuggable) {
                Log.d("GodsEyeWebView", "onPageFinished: $url")
              }
...
private class CanvasA2UIActionBridge(
  ...
  companion object {
    const val interfaceName: String = "godseyeCanvasA2UIAction"
  }
}
