...
import ai.godseye.app.ui.mobileAccentBorderStrong
...
import ai.godseye.app.ui.mobileSurface
import ai.godseye.app.ui.mobileText
import ai.godseye.app.ui.mobileTextSecondary
import ai.godseye.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.godseye.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.godseye.app.ui.mobileFontFamily,
