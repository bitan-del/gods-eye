    ...
    if (showDiagnostics) {
      Surface(
        ...
        Column(
          ...
          Text("GodsEye Android ${godsEyeAndroidVersionLabel()}", style = mobileCaption1, color = mobileTextSecondary)
          Button(
            onClick = {
    ...
    AnimatedVisibility(visible = advancedOpen) {
      Surface(
        ...
        Column(
          ...
          CommandBlock("godseye qr --setup-code-only")
          CommandBlock("godseye qr --json")
