---
title: "Kilo Gateway"
summary: "Use Kilo Gateway's unified API to access many models in Gods Eye"
read_when:
  - You want a single API key for many LLMs
  - You want to run models via Kilo Gateway in Gods Eye
---
...
```bash
godseye onboard --kilocode-api-key <key>
```
...
Gods Eye dynamically discovers available models from the Kilo Gateway at startup. Use
