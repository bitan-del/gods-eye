---
summary: "Use Qianfan's unified API to access many models in Gods Eye"
read_when:
...
3. Gods Eye installed on your system
...
4. Copy the API key for use with Gods Eye

## CLI setup

```bash
godseye onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Gods Eye Configuration](/gateway/configuration)
