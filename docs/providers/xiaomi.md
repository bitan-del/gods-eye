---
summary: "Use Xiaomi MiMo models with Gods Eye"
read_when:
  - You want Xiaomi MiMo models in Gods Eye
...
Xiaomi MiMo is the API platform for **MiMo** models. Gods Eye uses the Xiaomi
...
```bash
godseye onboard --auth-choice xiaomi-api-key
# or non-interactive
godseye onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
