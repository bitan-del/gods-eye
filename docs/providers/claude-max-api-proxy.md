...
You can point Gods Eye at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Gods Eye
...
- [Anthropic provider](/providers/anthropic) - Native Gods Eye integration with Claude setup-token or API keys
