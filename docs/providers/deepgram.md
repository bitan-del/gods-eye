...
Deepgram is a speech-to-text API. In Gods Eye it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, Gods Eye uploads the audio file to Deepgram and injects the transcript
