---
summary: "Use NVIDIA's OpenAI-compatible API in Gods Eye"
read_when:
  - You want to use NVIDIA models in Gods Eye
...
godseye onboard --auth-choice skip
godseye models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
