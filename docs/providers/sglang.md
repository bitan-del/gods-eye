---
summary: "Run Gods Eye with SGLang (OpenAI-compatible self-hosted server)"
read_when:
  - You want to run Gods Eye against a local SGLang server
...
Gods Eye can connect to SGLang using the `openai-completions` API.

Gods Eye can also **auto-discover** available models from SGLang when you opt
...
define `models.providers.sglang`, Gods Eye will query:
