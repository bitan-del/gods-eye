...
summary: "Testing utilities and patterns for Gods Eye plugins"
read_when:
...
Reference for test utilities, patterns, and lint enforcement for Gods Eye
plugins.
...
**Import:** `godseye/plugin-sdk/testing`
...
} from "godseye/plugin-sdk/testing";
```
...
import { installCommonResolveTargetErrorCases } from "godseye/plugin-sdk/testing";
...
import type { PluginRuntime } from "godseye/plugin-sdk/runtime-store";
...
1. **No monolithic root imports** -- `godseye/plugin-sdk` root barrel is rejected
...
Gods Eye uses Vitest with V8 coverage thresholds. For plugin tests:
