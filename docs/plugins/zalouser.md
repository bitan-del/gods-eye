...
read_when:
  - You want Zalo Personal (unofficial) support in Gods Eye
...
Zalo Personal support for Gods Eye via a plugin, using native `zca-js` to automate a normal Zalo user account.
