...
summary: "Step-by-step guide to building a messaging channel plugin for Gods Eye"
read_when:
  - You are building a new messaging channel plugin
  - You want to connect Gods Eye to a messaging platform
  - You need to understand the ChannelPlugin adapter surface
---

# Building Channel Plugins

This guide walks through building a channel plugin that connects Gods Eye to a
...
<Info>
  If you have not built any Gods Eye plugin before, read
...
Channel plugins do not need their own send/edit/react tools. Gods Eye keeps one
...
<Steps>
    ...
    ```json package.json
    {
      ...
      "godseye": {
        ...
        "channel": {
          "id": "acme-chat",
          "label": "Acme Chat",
          "blurb": "Connect Gods Eye to Acme Chat."
        }
      }
    }
    ```
  ...
  <Step title="Build the channel plugin object">
    ...
    import type { Gods EyeConfig } from "godseye/plugin-sdk/core";
  ...
  <Step title="Add a setup entry">
    ...
    Gods Eye loads this instead of the full entry when the channel is disabled
  ...
  <Step title="Handle inbound messages">
    ...
    Gods Eye. The typical pattern is a webhook that verifies the request and
    ...
    registerFull(api) {
      api.registerHttpRoute({
        ...
        handler: async (req, res) => {
          ...
          // Your inbound handler dispatches the message to Gods Eye.
...
├── package.json              # godseye.channel metadata
├── godseye.plugin.json      # Manifest with config schema
