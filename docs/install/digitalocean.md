---
summary: "Host Gods Eye on a DigitalOcean Droplet"
read_when:
  - Setting up Gods Eye on DigitalOcean
  - Looking for a simple paid VPS for Gods Eye
title: "DigitalOcean"
---

# DigitalOcean

Run a persistent Gods Eye Gateway on a DigitalOcean Droplet.
...
**Gateway will not start** -- Run `godseye doctor --non-interactive` and check logs with `journalctl --user -u godseye-gateway.service -n 50`.
