---
summary: "Install Gods Eye — installer script, npm/pnpm, from source, Docker, and more"
read_when:
...
The fastest way to install. It detects your OS, installs Node if needed, installs Gods Eye, and launches onboarding.
...
Or skip the link and use `pnpm godseye ...` from inside the repo. See [Setup](/start/setup) for full development workflows.
...
```bash
godseye --version      # confirm the CLI is available
godseye doctor         # check for config issues
godseye gateway status # verify the Gateway is running
```

## Hosting and deployment

Deploy Gods Eye on a cloud server or VPS:
...
<CardGroup cols={3}>
  ...
  <Card title="Uninstall" href="/install/uninstall" icon="trash-2">
    Remove Gods Eye completely.
  </Card>
</CardGroup>

## Troubleshooting: `godseye` not found

If the install succeeded but `godseye` is not found in your terminal:
