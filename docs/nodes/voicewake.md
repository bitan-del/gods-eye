...
Gods Eye treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.godseye/settings/voicewake.json`

Shape:

```json
{ "triggers": ["godseye", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
