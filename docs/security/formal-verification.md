...
summary: Machine-checked security models for Gods Eye’s highest-risk paths.
read_when:
...
This page tracks Gods Eye’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that Gods Eye enforces its
...
**What this is not (yet):** a proof that “Gods Eye is secure in all respects” or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/godseye-formal-models](https://github.com/vignesh07/godseye-formal-models).
...
```bash
git clone https://github.com/vignesh07/godseye-formal-models
cd godseye-formal-models
