---
summary: "Overview of Gods Eye onboarding options and flows"
read_when:
...
Gods Eye has two onboarding paths. Both configure auth, the Gateway, and
...
CLI command docs: [`godseye onboard`](/cli/onboard)

## macOS app onboarding

Open the Gods Eye app. The first-run wizard walks you through the same steps
