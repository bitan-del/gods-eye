---
summary: "First-run setup flow for Gods Eye (macOS app)"
read_when:
...
- By default, Gods Eye is a personal agent: one trusted operator boundary.
...
<Frame caption="Choose what permissions do you want to give Gods Eye">
...
<Step title="CLI">
  ...
  The app can install the global `godseye` CLI via npm/pnpm so terminal
