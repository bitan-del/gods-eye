---
summary: "Get Gods Eye installed and run your first chat in minutes."
read_when:
...
Install Gods Eye, run onboarding, and chat with your AI assistant — all in
...
<Accordion title="Advanced: environment variables">
  If you run Gods Eye as a service account or want custom paths:

- `GODSEYE_HOME` — home directory for internal path resolution
- `GODSEYE_STATE_DIR` — override the state directory
- `GODSEYE_CONFIG_PATH` — override the config file path
