---
summary: "Contributor guide for adding a new shared capability to the Gods Eye plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for Gods Eye core developers. If you are
  building an external plugin, see [Building Plugins](/plugins/building-plugins)
  instead.
</Info>

Use this when Gods Eye needs a new domain such as image generation, video
