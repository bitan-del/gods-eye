...
<Steps>
  ...
  <Step title="Load the skill">
    Start a new session so Gods Eye picks up the skill:
  ...
  <Step title="Test it">
    ...
    ```bash
    godseye agent --message "give me a greeting"
    ```
...
- **Test locally** — use `godseye agent --message "..."` to test before sharing
