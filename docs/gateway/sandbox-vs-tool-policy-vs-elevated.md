...
Gods Eye has three related (but different) controls:
...
Use the inspector to see what Gods Eye is _actually_ doing:
...
- `group:nodes`: `nodes`
- `group:godseye`: all built-in Gods Eye tools (excludes provider plugins)
