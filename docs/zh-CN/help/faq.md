...
- [快速开始与首次运行设置](#quick-start-and-firstrun-setup)
  ...
  - [无法访问 docs.godseye.ai（SSL 错误），怎么办？](#i-cant-access-docsgodseyeai-ssl-error-what-now)
...
### 无法访问 docs.godseye.ai（SSL 错误），怎么办

一些 Comcast/Xfinity 连接通过 Xfinity Advanced Security 错误地拦截了 `docs.godseye.ai`。禁用该功能或将 `docs.godseye.ai` 加入白名单，然后重试。更多详情：[故障排除](/help/troubleshooting#docsgodseyeai-shows-an-ssl-error-comcastxfinity)。
