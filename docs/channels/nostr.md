...
read_when:
  - You want Gods Eye to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables Gods Eye to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- Onboarding (`godseye onboard`) and `godseye channels add` list optional channel plugins.
...
```bash
godseye plugins install --link <path-to-godseye>/extensions/nostr
```
...
godseye channels add --channel nostr --private-key "$NOSTR_PRIVATE_KEY" --relay-urls "wss://relay.damus.io,wss://relay.primal.net"
```
...
```json5
{
  channels: {
    nostr: {
      ...
      profile: {
        name: "godseye",
        displayName: "Gods Eye",
        about: "Personal assistant DM bot",
        picture: "https://example.com/avatar.png",
        banner: "https://example.com/banner.png",
        website: "https://example.com",
        nip05: "godseye@example.com",
        lud16: "godseye@example.com",
      },
    },
  },
}
