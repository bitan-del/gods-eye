...
- Install via CLI: `godseye plugins install @godseye/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `godseye plugins install ./extensions/zalo`
   - From npm (if published): `godseye plugins install @godseye/zalo`
...
This page reflects current Gods Eye behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `godseye pairing list zalo`
  - `godseye pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in Gods Eye.
...
- Example: `godseye message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `godseye channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `godseye logs --follow`
