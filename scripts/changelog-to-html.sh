...
if [[ -z "$version_content" ]]; then
  echo "<h2>GodsEye $VERSION</h2>"
  echo "<p>Latest GodsEye update.</p>"
  echo "<p><a href=\"https://github.com/bitan-del/gods-eye/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
