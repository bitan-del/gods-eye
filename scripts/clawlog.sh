...
show_usage() {
    cat << EOF
clawlog - GodsEye Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View GodsEye logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    GodsEye logs flow through the macOS unified log (subsystem: ai.godseye).
