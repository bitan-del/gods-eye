...
export function copyBundledPluginMetadata(params = {}) {
  ...
  for (const dirent of fs.readdirSync(extensionsRoot, { withFileTypes: true })) {
    ...
    if (packageJson.godseye && "extensions" in packageJson.godseye) {
      packageJson.godseye = {
        ...packageJson.godseye,
        extensions: rewritePackageExtensions(packageJson.godseye.extensions),
        ...(typeof packageJson.godseye.setupEntry === "string"
          ? { setupEntry: rewritePackageEntry(packageJson.godseye.setupEntry) }
          : {}),
      };
    }
