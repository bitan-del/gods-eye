...
const FORBIDDEN_PATTERNS: Array<{ pattern: RegExp; hint: string }> = [
  {
    pattern: /["']godseye\/plugin-sdk["']/,
    hint: "Use godseye/plugin-sdk/<subpath> instead of the monolithic root entry.",
  },
  {
    pattern: /["']godseye\/plugin-sdk\/test-utils["']/,
    hint: "Use godseye/plugin-sdk/testing for the public extension test surface.",
  },
  {
    pattern: /["']godseye\/plugin-sdk\/compat["']/,
  ...
  },
  {
    ...
    hint: "Use test/helpers/extensions/* for repo-only helpers, or godseye/plugin-sdk/testing for public surfaces.",
  },
  {
