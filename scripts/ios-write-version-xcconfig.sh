...
- GODSEYE_GATEWAY_VERSION = exact package.json version
- GODSEYE_MARKETING_VERSION = short iOS/App Store version
- GODSEYE_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
GODSEYE_GATEWAY_VERSION = ${PACKAGE_VERSION}
GODSEYE_MARKETING_VERSION = ${MARKETING_VERSION}
GODSEYE_BUILD_VERSION = ${BUILD_NUMBER}
EOF
