...
const targetModel =
  modelIds.find((id) => id === "godseye/default") ?? modelIds.find((id) => id === "godseye");
if (!targetModel) {
  throw new Error(`godseye model missing from Open WebUI model list: ${JSON.stringify(modelIds)}`);
}
