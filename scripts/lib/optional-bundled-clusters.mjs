...
export const OPTIONAL_BUNDLED_BUILD_ENV = "GODSEYE_INCLUDE_OPTIONAL_BUNDLED";
...
export function hasReleasedBundledInstall(packageJson) {
  return (
    typeof packageJson?.godseye?.install?.npmSpec === "string" &&
    packageJson.godseye.install.npmSpec.trim().length > 0
  );
}
