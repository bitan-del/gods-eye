...
export DISPLAY=:1
export HOME=/tmp/godseye-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${GODSEYE_BROWSER_CDP_PORT:-9222}"
CDP_SOURCE_RANGE="${GODSEYE_BROWSER_CDP_SOURCE_RANGE:-}"
VNC_PORT="${GODSEYE_BROWSER_VNC_PORT:-5900}"
NOVNC_PORT="${GODSEYE_BROWSER_NOVNC_PORT:-6080}"
ENABLE_NOVNC="${GODSEYE_BROWSER_ENABLE_NOVNC:-1}"
HEADLESS="${GODSEYE_BROWSER_HEADLESS:-0}"
ALLOW_NO_SANDBOX="${GODSEYE_BROWSER_NO_SANDBOX:-0}"
NOVNC_PASSWORD="${GODSEYE_BROWSER_NOVNC_PASSWORD:-}"
DISABLE_GRAPHICS_FLAGS="${GODSEYE_BROWSER_DISABLE_GRAPHICS_FLAGS:-1}"
DISABLE_EXTENSIONS="${GODSEYE_BROWSER_DISABLE_EXTENSIONS:-1}"
RENDERER_PROCESS_LIMIT="${GODSEYE_BROWSER_RENDERER_PROCESS_LIMIT:-2}"
