...
# Output:
# - dist/GodsEye.app
# - dist/GodsEye-<version>.zip
# - dist/GodsEye-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.godseye.mac}"
...
ZIP="$ROOT_DIR/dist/GodsEye-$VERSION.zip"
DMG="$ROOT_DIR/dist/GodsEye-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/GodsEye-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/GodsEye-$VERSION.dSYM.zip"
