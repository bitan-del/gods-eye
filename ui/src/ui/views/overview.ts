...
export function renderOverview(props: OverviewProps) {
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ...
        <div style="margin-top: 6px">
          <span class="mono">godseye devices list</span><br />
          <span class="mono">godseye devices approve &lt;requestId&gt;</span>
        </div>
  ...
  const authHint = (() => {
    ...
    if (authHintKind === "required") {
      return html`
        <div class="muted" style="margin-top: 8px">
          ...
          <div style="margin-top: 6px">
            <span class="mono">godseye dashboard --no-open</span> → tokenized URL<br />
            <span class="mono">godseye doctor --generate-gateway-token</span> → set token
          </div>
          <div style="margin-top: 6px">
            <a
              class="session-link"
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ${t("overview.auth.failed", { command: "godseye dashboard --no-open" })}
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.gods-eye.org/web/dashboard"
                ...
                <label class="field">
                  ...
                  <div style="display: flex; align-items: center; gap: 8px;">
                    <input
                      ...
                      placeholder="GODSEYE_GATEWAY_TOKEN"
                    />
                    <button
                      type="button"
            ...
            ? html`
                <div class="login-gate__help" style="margin-top: 16px;">
                  ...
                  <ol class="login-gate__steps">
                    <li>${t("overview.connection.step1")}<code>godseye gateway run</code></li>
                    <li>${t("overview.connection.step2")}<code>godseye dashboard --no-open</code></li>
                    <li>${t("overview.connection.step3")}</li>
                    <li>${t("overview.connection.step4")}<code>godseye doctor --generate-gateway-token</code></li>
                  </ol>
