...
declare global {
  interface Window {
    __GODSEYE_CONTROL_UI_BASE_PATH__?: string;
  }
}
...
@customElement("godseye-app")
export class GodsEyeApp extends LitElement {
  ...
  @state() skillsViewTab: "my-skills" | "store" = "store";
  ...
  @state() skillsStoreDetail: import("./controllers/skills.ts").StoreSkillDetail | null = null;
