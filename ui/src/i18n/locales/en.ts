...
export const en: TranslationMap = {
  ...
  tabs: {
    ...
    aiAgents: "AI & Agents",
    studioImageGen: "Image Gen",
    studioVideoGen: "Video Gen",
    studioBrand: "Brand",
  ...
  subtitles: {
    ...
    agentStore: "Create and manage AI agents.",
    connectors: "Connect messaging channels.",
    security: "Defense-in-depth security layers.",
    nodes: "Paired devices and commands.",
    chat: "Gateway chat for quick interventions.",
    config: "Edit godseye.json.",
    ...
    studioImageGen: "Generate images with brand context.",
    studioVideoGen: "Create videos with brand awareness.",
    studioBrand: "Brand profiles and DNA scanner.",
    studioCalendar: "Content calendar and scheduling.",
    studioGallery: "Browse all generated assets.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "On mobile? Copy the full URL (including #token=...) from godseye dashboard --no-open on your desktop.",
    },
    insecure: {
