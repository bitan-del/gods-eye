...
import { isSecretRef, type GodsEyeConfig } from "godseye/plugin-sdk/core";
...
export function listEnabledGoogleChatAccounts(cfg: GodsEyeConfig): ResolvedGoogleChatAccount[] {
