...
import { createMessageToolCardSchema } from "godseye/plugin-sdk/channel-actions";
import { createTopLevelChannelConfigAdapter } from "godseye/plugin-sdk/channel-config-helpers";
import type {
...
} from "godseye/plugin-sdk/directory-runtime";
...
import { createComputedAccountStatusAdapter } from "godseye/plugin-sdk/status-helpers";
import type { ChannelMessageActionName, ChannelPlugin, GodsEyeConfig } from "../runtime-api.js";
import {
...
const resolveMSTeamsChannelConfig = (cfg: GodsEyeConfig) => ({
...
export const msteamsPlugin: ChannelPlugin<ResolvedMSTeamsAccount, ProbeMSTeamsResult> =
  createChatChannelPlugin({
    ...
    security: {
      collectWarnings: projectConfigWarningCollector<{ cfg: GodsEyeConfig }>(
