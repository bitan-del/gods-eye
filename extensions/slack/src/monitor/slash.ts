...
import { type ChatCommandDefinition, type CommandArgs } from "godseye/plugin-sdk/command-auth";
import {
...
import { chunkItems } from "godseye/plugin-sdk/text-runtime";
...
const SLACK_COMMAND_ARG_ACTION_ID = "godseye_cmdarg";
