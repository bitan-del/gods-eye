import type { DirectoryConfigParams } from "godseye/plugin-sdk/directory-runtime";
import { buildMessagingTarget, type MessagingTarget } from "godseye/plugin-sdk/messaging-targets";
