...
vi.mock("godseye/plugin-sdk/routing", async () => {
  const actual = await vi.importActual<typeof import("godseye/plugin-sdk/routing")>(
...
vi.mock("godseye/plugin-sdk/agent-runtime", async () => {
  const actual = await vi.importActual<typeof import("godseye/plugin-sdk/agent-runtime")>(
