...
type LoadedConfig = ReturnType<typeof import("godseye/plugin-sdk/config-runtime").loadConfig>;
type RuntimeEnv = import("godseye/plugin-sdk/runtime-env").RuntimeEnv;
type Logger = ReturnType<typeof import("godseye/plugin-sdk/runtime-env").createSubsystemLogger>;
