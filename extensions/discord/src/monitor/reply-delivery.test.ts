...
vi.mock("godseye/plugin-sdk/retry-runtime", async () => {
  const actual = await vi.importActual<typeof import("godseye/plugin-sdk/retry-runtime")>(
    "godseye/plugin-sdk/retry-runtime",
  );
  return {
    ...actual,
