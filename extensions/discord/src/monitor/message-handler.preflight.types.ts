...
import type { SessionBindingRecord } from "godseye/plugin-sdk/conversation-runtime";
import type { HistoryEntry } from "godseye/plugin-sdk/reply-history";
import type { resolveAgentRoute } from "godseye/plugin-sdk/routing";
...
export type LoadedConfig = ReturnType<
  typeof import("godseye/plugin-sdk/config-runtime").loadConfig
>;
export type RuntimeEnv = import("godseye/plugin-sdk/runtime-env").RuntimeEnv;
