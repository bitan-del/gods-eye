...
import type { OpenClawConfig, ReplyToMode } from "godseye/plugin-sdk/config-runtime";
...
import { getPluginCommandSpecs } from "godseye/plugin-sdk/plugin-runtime";
...
} from "godseye/plugin-sdk/runtime-group-policy";
...
export type MonitorDiscordOpts = {
  ...
  runtime?: RuntimeEnv;
  channelRuntime?: import("godseye/plugin-sdk/channel-core").PluginRuntime["channel"];
...
export async function monitorDiscordProvider(opts: MonitorDiscordOpts = {}) {
  ...
  try {
    ...
    const guildHistories = new Map<
      string,
      import("godseye/plugin-sdk/reply-history").HistoryEntry[]
    >();
