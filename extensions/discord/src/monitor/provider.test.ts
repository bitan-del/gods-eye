...
import { AcpRuntimeError } from "godseye/plugin-sdk/acp-runtime";
...
let runtimeEnvModule: typeof import("godseye/plugin-sdk/runtime-env");
...
describe("monitorDiscordProvider", () => {
  ...
  beforeAll(async () => {
    vi.doMock("godseye/plugin-sdk/plugin-runtime", async () => {
    ...
    runtimeEnvModule = await import("godseye/plugin-sdk/runtime-env");
