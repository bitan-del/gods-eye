...
import * as commandRegistryModule from "godseye/plugin-sdk/command-auth";
import type { ChatCommandDefinition, CommandArgsParsing } from "godseye/plugin-sdk/command-auth";
import type { ModelsProviderData } from "godseye/plugin-sdk/command-auth";
import type { OpenClawConfig } from "godseye/plugin-sdk/config-runtime";
import * as pluginRuntimeModule from "godseye/plugin-sdk/plugin-runtime";
import * as dispatcherModule from "godseye/plugin-sdk/reply-dispatch-runtime";
import * as globalsModule from "godseye/plugin-sdk/runtime-env";
import * as commandTextModule from "godseye/plugin-sdk/text-runtime";
