...
vi.mock("godseye/plugin-sdk/approval-gateway-runtime", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("godseye/plugin-sdk/approval-gateway-runtime")>();
  return {
    ...actual,
