...
import type { GodsEyeConfig, loadConfig } from "../../../../src/config/config.js";
...
function createNativeCommand(
  ...
  opts?: {
    ...
    discordConfig?: NonNullable<GodsEyeConfig["channels"]>["discord"];
  },
...
describe("createDiscordNativeCommand option wiring", () => {
  ...
  it("truncates Discord command and option descriptions to Discord's limit", () => {
    ...
    const discordConfig = {} as NonNullable<GodsEyeConfig["channels"]>["discord"];
