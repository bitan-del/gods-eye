...
let listNativeCommandSpecs: typeof import("godseye/plugin-sdk/command-auth").listNativeCommandSpecs;
...
describe("createDiscordNativeCommand option wiring", () => {
  beforeAll(async () => {
    ({ listNativeCommandSpecs } = await import("godseye/plugin-sdk/command-auth"));
