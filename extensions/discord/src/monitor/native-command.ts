...
} from "godseye/plugin-sdk/command-auth-native";
import type { OpenClawConfig, loadConfig } from "godseye/plugin-sdk/config-runtime";
...
} from "godseye/plugin-sdk/native-command-registry";
import * as pluginRuntime from "godseye/plugin-sdk/plugin-runtime";
import { resolveChunkMode, resolveTextChunkLimit } from "godseye/plugin-sdk/reply-chunking";
import {
