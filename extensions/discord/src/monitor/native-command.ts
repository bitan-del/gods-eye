...
import type { GodsEyeConfig, loadConfig } from "godseye/plugin-sdk/config-runtime";
import { isDangerousNameMatchingEnabled } from "godseye/plugin-sdk/config-runtime";
import { resolveOpenProviderRuntimeGroupPolicy } from "godseye/plugin-sdk/config-runtime";
import { buildPairingReply } from "godseye/plugin-sdk/conversation-runtime";
import { getAgentScopedMediaLocalRoots } from "godseye/plugin-sdk/media-runtime";
import { executePluginCommand, matchPluginCommand } from "godseye/plugin-sdk/plugin-runtime";
import {
...
import { dispatchReplyWithDispatcher } from "godseye/plugin-sdk/reply-runtime";
...
type DiscordConfig = NonNullable<GodsEyeConfig["channels"]>["discord"];
