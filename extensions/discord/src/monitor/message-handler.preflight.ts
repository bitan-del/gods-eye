...
import { resolveControlCommandGate } from "godseye/plugin-sdk/command-auth-native";
import { hasControlCommand } from "godseye/plugin-sdk/command-detection";
import { shouldHandleTextCommands } from "godseye/plugin-sdk/command-surface";
import { isDangerousNameMatchingEnabled, loadConfig } from "godseye/plugin-sdk/config-runtime";
import type { SessionBindingRecord } from "godseye/plugin-sdk/conversation-binding-runtime";
import { enqueueSystemEvent, recordChannelActivity } from "godseye/plugin-sdk/infra-runtime";
import {
  recordPendingHistoryEntryIfEnabled,
  type HistoryEntry,
} from "godseye/plugin-sdk/reply-history";
import { getChildLogger, logVerbose, shouldLogVerbose } from "godseye/plugin-sdk/runtime-env";
import { logDebug, normalizeOptionalString } from "godseye/plugin-sdk/text-runtime";
...
let conversationRuntimePromise:
  | Promise<typeof import("godseye/plugin-sdk/conversation-binding-runtime")>
  | undefined;
...
async function loadConversationRuntime() {
  conversationRuntimePromise ??= import("godseye/plugin-sdk/conversation-binding-runtime");
