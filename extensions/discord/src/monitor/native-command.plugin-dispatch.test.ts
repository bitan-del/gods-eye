...
import type { NativeCommandSpec } from "godseye/plugin-sdk/command-auth";
import type { OpenClawConfig } from "godseye/plugin-sdk/config-runtime";
import { clearPluginCommands, registerPluginCommand } from "godseye/plugin-sdk/plugin-runtime";
...
vi.mock("godseye/plugin-sdk/plugin-runtime", async () => {
  const actual = await vi.importActual<typeof import("godseye/plugin-sdk/plugin-runtime")>(
    "godseye/plugin-sdk/plugin-runtime",
  );
  return {
    ...actual,
...
vi.mock("godseye/plugin-sdk/reply-runtime", async () => {
  const actual = await vi.importActual<typeof import("godseye/plugin-sdk/reply-runtime")>(
    "godseye/plugin-sdk/reply-runtime",
  );
  return {
    ...actual,
...
describe("Discord native plugin command dispatch", () => {
  ...
  beforeEach(async () => {
    ...
    const actualPluginRuntime = await vi.importActual<
      typeof import("godseye/plugin-sdk/plugin-runtime")
    >("godseye/plugin-sdk/plugin-runtime");
    ...
    discordNativeCommandTesting.setMatchPluginCommand(
      runtimeModuleMocks.matchPluginCommand as typeof import("godseye/plugin-sdk/plugin-runtime").matchPluginCommand,
    );
    discordNativeCommandTesting.setExecutePluginCommand(
      runtimeModuleMocks.executePluginCommand as typeof import("godseye/plugin-sdk/plugin-runtime").executePluginCommand,
    );
    discordNativeCommandTesting.setDispatchReplyWithDispatcher(
      runtimeModuleMocks.dispatchReplyWithDispatcher as typeof import("godseye/plugin-sdk/reply-runtime").dispatchReplyWithDispatcher,
    );
