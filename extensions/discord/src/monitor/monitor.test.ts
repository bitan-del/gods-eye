...
import { buildPluginBindingApprovalCustomId } from "godseye/plugin-sdk/conversation-runtime";
...
async function createInfraRuntimeMock(
  importOriginal: () => Promise<typeof import("godseye/plugin-sdk/infra-runtime")>,
) {
...
vi.mock("godseye/plugin-sdk/infra-runtime", createInfraRuntimeMock);
vi.mock("godseye/plugin-sdk/infra-runtime.js", createInfraRuntimeMock);
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/godseye-sessions-test.json");
