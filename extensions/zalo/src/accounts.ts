...
function mergeZaloAccountConfig(cfg: GodsEyeConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: GodsEyeConfig): ResolvedZaloAccount[] {
