...
vi.mock("godseye/plugin-sdk/runtime-env", async (importOriginal) => {
  const actual = await importOriginal<typeof import("godseye/plugin-sdk/runtime-env")>();
  const logger = {
    child: () => logger,
...
vi.mock("../auth-store.js", () => ({
  WA_WEB_AUTH_DIR: "/tmp/godseye-oauth/whatsapp/default",
  resolveDefaultWebAuthDir: () => "/tmp/godseye-oauth/whatsapp/default",
