...
import { redactIdentifier } from "godseye/plugin-sdk/logging-core";
...
let resetLogger: typeof import("godseye/plugin-sdk/runtime-env").resetLogger;
let setLoggerOverride: typeof import("godseye/plugin-sdk/runtime-env").setLoggerOverride;
...
describe("web outbound", () => {
  ...
  beforeAll(async () => {
    ...
    ({ resetLogger, setLoggerOverride } = await import("godseye/plugin-sdk/runtime-env"));
  });
