...
import type { GodsEyePluginConfigSchema } from "../runtime-api.js";
...
function isAcpxPluginRoot(dir: string): boolean {
  return (
    fs.existsSync(path.join(dir, "godseye.plugin.json")) &&
...
export function createAcpxPluginConfigSchema(): GodsEyePluginConfigSchema {
  return {
