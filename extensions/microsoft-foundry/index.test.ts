...
import type { GodsEyeConfig } from "../../src/config/types.godseye.js";
...
vi.mock("godseye/plugin-sdk/provider-auth", async () => {
  const actual = await vi.importActual<typeof import("godseye/plugin-sdk/provider-auth")>(
    "godseye/plugin-sdk/provider-auth",
  );
  return {
    ...actual,
