...
import { parseDurationMs } from "godseye/plugin-sdk/cli-runtime";
import {
  definePluginEntry,
...
import { fetchClaudeUsage } from "godseye/plugin-sdk/provider-usage";
...
function buildAnthropicAuthDoctorHint(params: {
  ...
  return [
    ...
    `Fix: run "${formatCliCommand("godseye doctor --yes")}"`,
  ].join("\n");
}
