import { formatCliCommand, parseDurationMs } from "godseye/plugin-sdk/cli-runtime";
import type {
  OpenClawPluginApi,
  ProviderAuthContext,
...
import { cloneFirstTemplateModel } from "godseye/plugin-sdk/provider-model-shared";
