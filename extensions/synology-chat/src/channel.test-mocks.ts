...
vi.mock("godseye/plugin-sdk/setup", async () => {
  const actual = await vi.importActual<object>("godseye/plugin-sdk/setup");
  return {
    ...actual,
...
vi.mock("godseye/plugin-sdk/channel-config-schema", async () => {
  const actual = await vi.importActual<object>("godseye/plugin-sdk/channel-config-schema");
  return {
    ...actual,
...
vi.mock("godseye/plugin-sdk/webhook-ingress", async () => {
  const actual = await vi.importActual<object>("godseye/plugin-sdk/webhook-ingress");
  return {
    ...actual,
