import { ensureAuthProfileStore, listProfilesForProvider } from "godseye/plugin-sdk/agent-runtime";
import { definePluginEntry, type ProviderAuthContext } from "godseye/plugin-sdk/plugin-entry";
import { coerceSecretRef } from "godseye/plugin-sdk/provider-auth";
import { githubCopilotLoginCommand } from "godseye/plugin-sdk/provider-auth-login";
