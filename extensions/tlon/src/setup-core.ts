...
export async function resolveTlonSetupConfigured(cfg: GodsEyeConfig): Promise<boolean> {
...
export async function resolveTlonSetupStatusLines(cfg: GodsEyeConfig): Promise<string[]> {
