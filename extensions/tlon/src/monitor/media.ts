...
import { fetchWithSsrFGuard } from "godseye/plugin-sdk/infra-runtime";
import { getDefaultSsrFPolicy } from "../urbit/context.js";

// Default to GodsEye workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".godseye", "workspace", "media", "inbound");
 ...
 * Format matches GodsEye's expected attachment structure.
 */
