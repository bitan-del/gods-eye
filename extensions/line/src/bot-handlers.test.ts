...
vi.mock("godseye/plugin-sdk/channel-inbound", () => ({
  buildMentionRegexes: () => [],
...
vi.mock("godseye/plugin-sdk/channel-pairing", () => ({
...
vi.mock("godseye/plugin-sdk/command-auth", () => ({
...
vi.mock("godseye/plugin-sdk/config-runtime", () => ({
...
vi.mock("godseye/plugin-sdk/group-access", () => ({
...
vi.mock("godseye/plugin-sdk/routing", () => ({
