...
import type { GodsEyePluginConfigSchema } from "godseye/plugin-sdk/core";
...
export function createOpenShellPluginConfigSchema(): GodsEyePluginConfigSchema {
