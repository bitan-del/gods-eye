...
import { getRuntimeConfigSnapshot } from "godseye/plugin-sdk/runtime-config-snapshot";
...
type TelegramChunkMode = ReturnType<
  typeof import("godseye/plugin-sdk/reply-dispatch-runtime").resolveChunkMode
>;
type TelegramNativeReplyPayload = import("godseye/plugin-sdk/reply-dispatch-runtime").ReplyPayload;
