...
import type { GetReplyOptions, MsgContext } from "godseye/plugin-sdk/reply-runtime";
...
type FetchRemoteMediaFn = typeof import("godseye/plugin-sdk/media-runtime").fetchRemoteMedia;
...
export const telegramBotDepsForTest: TelegramBotDeps = {
  loadConfig: (() =>
    ...
    }) as GodsEyeConfig) as TelegramBotDeps["loadConfig"],
...
export async function mockMediaRuntimeModuleForTest(
  importOriginal: () => Promise<typeof import("godseye/plugin-sdk/media-runtime")>,
) {
...
vi.mock("godseye/plugin-sdk/media-runtime", mockMediaRuntimeModuleForTest);
...
vi.doMock("godseye/plugin-sdk/agent-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("godseye/plugin-sdk/agent-runtime")>();
  return {
    ...actual,
