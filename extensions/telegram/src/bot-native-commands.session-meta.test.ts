...
type ResolveConfiguredBindingRouteFn =
  typeof import("godseye/plugin-sdk/conversation-runtime").resolveConfiguredBindingRoute;
type EnsureConfiguredBindingRouteReadyFn =
  typeof import("godseye/plugin-sdk/conversation-runtime").ensureConfiguredBindingRouteReady;
...
vi.mock("godseye/plugin-sdk/command-auth", async (importOriginal) => {
...
describe("registerTelegramNativeCommands — session metadata", () => {
  ...
  beforeEach(() => {
    ...
    sessionMocks.resolveStorePath.mockClear().mockReturnValue("/tmp/godseye-sessions.json");
