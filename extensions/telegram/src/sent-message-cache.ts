import { createScopedExpiringIdCache, resolveGlobalMap } from "godseye/plugin-sdk/text-runtime";
 ...
 */
const TELEGRAM_SENT_MESSAGES_KEY = Symbol.for("godseye.telegramSentMessages");
