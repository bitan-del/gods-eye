...
vi.mock("godseye/plugin-sdk/hook-runtime", async () => {
  const actual = await vi.importActual<typeof import("godseye/plugin-sdk/hook-runtime")>(
    "godseye/plugin-sdk/hook-runtime",
  );
  return {
    ...actual,
