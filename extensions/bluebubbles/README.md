...
This directory contains the **BlueBubbles external channel plugin** for Gods Eye.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `godseye/plugin-sdk` helpers.
